...
| 张宥  |https://github.com/sdfhjisd|   51285903068|
...
| 赖鑫 | Week14、Week18                      | 导出与项目工程化系统，Mac端功能测试，Mac证书问题              | 笔记与文章单篇/多篇导出、Markdown/PDF 导出、Bug修复与联调、Docker部署、项目文档整理              | 支持文章导出与项目部署，实现项目最终交付                        |
